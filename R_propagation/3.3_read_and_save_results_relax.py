...
U_rans_ml = read_field(f'3_pc_Re_tau_550_relax/{ml_max_step}/U',mesh_size, n_cells_along_x)
k_rans_ml = read_field(f'3_pc_Re_tau_550_relax/{ml_max_step}/k',mesh_size, n_cells_along_x)
omega_rans_ml = read_field(f'3_pc_Re_tau_550_relax/{ml_max_step}/omega',mesh_size, n_cells_along_x)
np.save('data/U_rans_ml_relax.npy', U_rans_ml)
np.save('data/k_rans_ml_relax.npy', k_rans_ml)
np.save('data/omega_rans_ml_relax.npy', omega_rans_ml)